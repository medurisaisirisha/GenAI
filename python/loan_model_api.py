...
models = {
    "decision_tree": joblib.load(r"D:\GenerativeAI LLMs\Day2\Result\decision_tree_model.pkl"),
    "logistic_regression": joblib.load(r"D:\GenerativeAI LLMs\Day2\Result\logistic_regression_model.pkl"),
    "random_forest": joblib.load(r"D:\GenerativeAI LLMs\Day2\Result\random_forest_model.pkl"),
    "xgboost": joblib.load(r"D:\GenerativeAI LLMs\Day2\Result\xgboost_model.pkl")
}
